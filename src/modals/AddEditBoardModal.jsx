    ...
    >
      ...
      >
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <div>
            <button
              className=" w-full items-center hover:opacity-70 dark:text-[#111212] dark:bg-white  text-white bg-[#494F55] py-2 rounded-full "
              onClick={() => {
                setNewColumns((state) => [
                  ...state,
            ...
            <button
              ...
              className=" w-full items-center hover:opacity-70 dark:text-white dark:bg-[#010B13] mt-8 relative  text-white bg-[#111212] py-2 rounded-full"
            >
